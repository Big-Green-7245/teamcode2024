...
public class AutoSpecimenPathTest {
    ...
    private static final Pose2d SPECIMEN_SAMPLE_3_DEPOSIT_POSE = new Pose2d(-40, 52, 3 * Math.PI / 4);
    private static final Pose2d OBSERVATION_ZONE_POSE = new Pose2d(-36, 61, 3 * Math.PI / 2);
    ...
    public static void main(String[] args) {
        ...
        builder = builder
                ...
                .splineToLinearHeading(SPECIMEN_SAMPLE_3_DEPOSIT_POSE, Math.PI / 4)
