...
public class AutoSpecimenPathTest {
    private static final Pose2d INITIAL_POSE = new Pose2d(-4, 63, Math.PI / 2);
    private static final Pose2d INITIAL_SUBMERSIBLE_POSE = new Pose2d(-4, 36, Math.PI / 2);
    private static final int OBSERVATION_ZONE_Y = 48;
    private static final Pose2d OBSERVATION_ZONE_POSE = new Pose2d(-36, 62, 3 * Math.PI / 2);
    ...
    private static final Pose2d SAMPLE_1_POSE = new Pose2d(-40, 14, 3 * Math.PI / 2);
    private static final Pose2d SAMPLE_1_DEPOSIT_POSE = new Pose2d(-42, OBSERVATION_ZONE_Y, 3 * Math.PI / 2);
    private static final Pose2d SAMPLE_2_POSE = new Pose2d(-50, 14, 3 * Math.PI / 2);
    private static final Pose2d SAMPLE_2_DEPOSIT_POSE = new Pose2d(-52, OBSERVATION_ZONE_Y, 3 * Math.PI / 2);
    private static final Pose2d SAMPLE_3_POSE = new Pose2d(-60, 14, 3 * Math.PI / 2);
    private static final Pose2d SAMPLE_3_DEPOSIT_POSE = new Pose2d(-62, OBSERVATION_ZONE_Y, 3 * Math.PI / 2);
    ...
    public static void main(String[] args) {
        ...
        bot.runAction(bot.getDrive().actionBuilder(INITIAL_POSE)
                ...
                .splineToSplineHeading(SAMPLE_1_POSE, Math.PI / 2)
                // Push first sample to observation zone
                .splineToConstantHeading(SAMPLE_1_DEPOSIT_POSE.position, Math.PI / 2)
                // Move to second sample
                .setTangent(3 * Math.PI / 2)
                .splineToConstantHeading(SAMPLE_2_POSE.position, Math.PI / 2)
                // Push second sample to observation zone
                .splineToConstantHeading(SAMPLE_2_DEPOSIT_POSE.position, Math.PI / 2)
                // Move to third sample
                .setTangent(3 * Math.PI / 2)
                .splineToConstantHeading(SAMPLE_3_POSE.position, Math.PI / 2)
                // Push third sample to observation zone
                .splineToConstantHeading(SAMPLE_3_DEPOSIT_POSE.position, Math.PI / 2)
